        ...
        <main>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">{/* Your content */}
            ...
            <p className="text-center max-w-7xl px-4 sm:px-6 lg:px-8 text-gray-900">
              เป็นร้านชาบูที่เน้นการให้บริการที่ครอบคลุมทุกสไตล์การทานชาบู ตั้งแต่โซนโต๊ะธรรมดาและโซนชาบูสายพานสุดสะดวก
            </p>
            <p className="text-center max-w-7xl px-4 sm:px-6 lg:px-8 text-gray-900">
              ลูกค้าสามารถเลือกสไตล์การรับประทานที่ตรงกับความต้องการของตนได้ ทำให้เหมาะกับการมาทานทั้งแบบกลุ่มครอบครัว เพื่อนฝูง หรือแบบเดี่ยว
            </p>
            ...
            <p className="text-center max-w-7xl px-4 sm:px-6 lg:px-8 text-gray-500">
              โซนที่นั่งทั่วไป สั่งไม่อั้น ราคา 499/ท่าน อร่อยไม่อั้นกว่า 160 รายการ
            </p>
            <p className="text-center max-w-7xl px-4 sm:px-6 lg:px-8 text-gray-500">
              (*ราคายังไม่รวมภาษี 7%)
            </p>
